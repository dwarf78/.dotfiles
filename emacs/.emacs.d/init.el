...
(custom-set-faces
 ...
 '(org-document-title ((t (:inherit default :weight bold :foreground "#d4d4d4" :font "EB Garamond" :height 2.0 :underline nil))))
 '(org-headline-done ((t (:inherit default :weight bold :foreground "#d4d4d4" :font "EB Garamond" :strike-through t))))
 '(org-level-1 ((t (:inherit default :weight bold :foreground "#d4d4d4" :font "EB Garamond" :height 1.75))))
 '(org-level-2 ((t (:inherit default :weight bold :foreground "#d4d4d4" :font "EB Garamond" :height 1.5))))
 '(org-level-3 ((t (:inherit default :weight bold :foreground "#d4d4d4" :font "EB Garamond" :height 1.25))))
