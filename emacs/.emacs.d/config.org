...
#+begin_src emacs-lisp
  (use-package org-roam
    ...
    :custom
    (org-roam-directory "~/Documents/02_Working/org/Roam")
    ...
    (org-roam-capture-templates'(
                                 ...
                                 ("t" "term definition note" plain
                                  (file "~/Documents/02_Working/org/Roam/Templates/Definition.org")
                                  :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n #+date: %U\n#+filetags: Definition")
                                  :unnarrowed t)     
                                 ("f" "fleeting note" plain
                                  (file "~/Documents/02_Working/org/Roam/Templates/Fleeting.org")
                                  :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n #+date: %U\n#+filetags: Fleeting")
                                  :unnarrowed t)
                                 ("l" "literature note" plain
                                  (file "~/Documents/02_Working/org/Roam/Templates/Literature.org")
                                  :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n #+date: %U\n#+filetags: Literature")
                                  :unnarrowed t)
                                 ("p" "permanent note" plain
                                  (file "~/Documents/02_Working/org/Roam/Templates/Permanent.org")
                                  :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n #+date: %U\n#+filetags: Permanent")
                                  :unnarrowed t)
                                 ("r" "reference note" plain
                                  (file "~/Documents/02_Working/org/Roam/Templates/Reference.org")
                                  :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n #+date: %U\n#+filetags: Reference")
                                  :unnarrowed t)
                                 ("m" "map of contents" plain
                                  (file "~/Documents/02_Working/org/Roam/Templates/MOC.org")
                                  :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n #+date: %U\n#+filetags: MOC")
                                  :unnarrowed t)
                                 )
                               )
...
#+begin_src emacs-lisp
  ...
  (use-package deft
	       :ensure t
	       :commands (deft)
	       :config (setq deft-directory "~/Documents/02_Working/org/"
			     deft-recursive t
...
#+begin_src emacs-lisp
  ...
  (setq bib-files-directory (directory-files
			     (concat (getenv "HOME") "/Documents/03_Archive/bibliography") t
			     "^[A-Z|a-z].+.bib$")
	pdf-files-directory (concat (getenv "HOME") "/Documents/03_Archive/bibliography/pdf"))
