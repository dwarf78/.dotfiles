...
(use-package elfeed
  ...
  ;; (setq elfeed-feeds
  ;;       '(("https://www.glistatigenerali.com/feed/" politics)
  ;;         ("https://www.theatlantic.com/feed/all/" politics)
  ;;         ("http://www.limesonline.com/feed" politics)
  ;;         ("https://c-for-dummies.com/blog/?feed=rss2" programming)
  ;;         ("https://johnhcochrane.blogspot.com/feeds/posts/default?alt=rss" markets)
  ;;         ("https://aswathdamodaran.blogspot.com/feeds/posts/default?alt=rss" markets)
  ;;         ("https://clopremium.co.uk/feed/" markets))
  ;;       )
  :bind
  ("C-x w" . elfeed ))
